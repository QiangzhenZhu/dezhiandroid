...
import cn.xiaocool.dezhischool.main.CircleImagesActivity;
...
public class ClassEventsAdapter extends BaseAdapter {
    ...
    private List<NewClassevents.ClassEventData> homeworkDataList;
    ...
    //    private int a;
    public ClassEventsAdapter(List<NewClassevents.ClassEventData> homeworkDataList, Context mContext, Handler handler, LinearLayout commentView) {
...
//                context.startActivity(intent);
        ...
        //计算已读未读和已报名
        final ArrayList<NewClassevents.ClassEventData.ReciverlistInfo> notReads = new ArrayList<>();
        final ArrayList<NewClassevents.ClassEventData.ReciverlistInfo> alreadyReads = new ArrayList<>();
