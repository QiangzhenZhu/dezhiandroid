...
public class EListAdapter extends BaseExpandableListAdapter implements ExpandableListView.OnChildClickListener {
    ...
    private int size;
    private String type="2";   //1是选择班级，2是选择人

//    public EListAdapter(MyClassListActivity myClassListActivity, ArrayList<Group> groups, CheckBox quan_check, TextView down_selected_num) {
//        this.textView = down_selected_num;
