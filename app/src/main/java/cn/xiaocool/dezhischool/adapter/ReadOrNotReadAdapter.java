...
public class ReadOrNotReadAdapter extends BaseAdapter {
    ...
    private ArrayList<LikeBean> classListDataList;
    private LayoutInflater inflater;
    private Context mContext;
    private String type;
    private DisplayImageOptions displayImageOptions;
    public ReadOrNotReadAdapter(ArrayList<LikeBean> classListDataList, Context context,String type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final LikeBean data = classListDataList.get(position);
...
//                intent.putExtra("reciver_id", data.getUserid());
//                intent.putExtra("chat_name", data.getName());
//                mContext.startActivity(intent);
        ...
        ImageLoader.getInstance().displayImage(NetConstantUrl.NET_CIRCLEPIC_HOST + data.getAvatar(), holder.teacher_avatar, displayImageOptions);
