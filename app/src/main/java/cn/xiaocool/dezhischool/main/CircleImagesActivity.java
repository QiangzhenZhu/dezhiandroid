...
import cn.xiaocool.dezhischool.service.ImageBrowsePresenter;
import cn.xiaocool.dezhischool.service.ImageBrowseView;
...
public class CircleImagesActivity extends BaseActivity implements ViewPager.OnPageChangeListener,View.OnClickListener,ImageBrowseView {
    ...
    private cn.xiaocool.dezhischool.adapter.ViewPageAdapter adapter;
...
//        steepStatusBar();
    ...
    public void setImageBrowse(List<String> images, int position) {
        if(adapter == null && images != null && images.size() != 0){
            adapter = new cn.xiaocool.dezhischool.adapter.ViewPageAdapter(this,images);
    ...
    private void setStatusHeight() {
        ...
        layoutParams.width = cn.xiaocool.dezhischool.utils.ScreenUtils.getScreenWidth(this);
        layoutParams.height = cn.xiaocool.dezhischool.utils.ScreenUtils.getStatusHeight(this);
