...
import cn.xiaocool.dezhischool.activity.MessageActivity;
...
//        }
    ...
    @OnClick({R.id.second_rl_school_news, R.id.second_rl_class_news, R.id.second_rl_message,R.id.second_rl_school_announce})
