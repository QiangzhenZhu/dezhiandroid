package cn.xiaocool.dezhischool.view.update;
...
public class UpdateService extends Service {
    ...
    private void startDownload() {
        cn.xiaocool.dezhischool.view.update.UpdateManager.getInstance().startDownloads(apkURL, filePath, new UpdateDownloadListener() {
