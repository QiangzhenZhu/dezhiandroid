...
import cn.xiaocool.dezhischool.adapter.ClassEventsAdapter;
import cn.xiaocool.dezhischool.bean.Comments;
import cn.xiaocool.dezhischool.bean.LikeBean;
import cn.xiaocool.dezhischool.bean.NewClassevents;
...
public class SpaceClickClassEventActivity extends BaseActivity implements View.OnClickListener{
    ...
    private List<NewClassevents.ClassEventData> classEventDataList;
                        ...
                        try {
                            ...
                            if (state.equals(CommunalInterfaces._STATE)){
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    NewClassevents.ClassEventData classEventData = new NewClassevents.ClassEventData();
                                    ...
                                    ArrayList<NewClassevents.ClassEventData.ReciverlistInfo> reciverlistInfos = new ArrayList<>();

                                    for (int j=0;j<reciveObjectArray.length();j++){
                                        JSONObject reciveObject = reciveObjectArray.optJSONObject(j);
                                        NewClassevents.ClassEventData.ReciverlistInfo reciverlistInfo = new NewClassevents.ClassEventData.ReciverlistInfo();
                                    ...
                                    ArrayList<NewClassevents.ClassEventData.IsApplyList> isapplylistInfos = new ArrayList<>();
                                    for (int j=0;j<isapplyObjectArray.length();j++){
                                        JSONObject isapplyObject = isapplyObjectArray.optJSONObject(j);
                                        NewClassevents.ClassEventData.IsApplyList isApply = new NewClassevents.ClassEventData.IsApplyList();
