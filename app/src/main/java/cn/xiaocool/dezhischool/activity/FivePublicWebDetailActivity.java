...
public class FivePublicWebDetailActivity extends BaseActivity {
    ...
    public void requsetData() {
        ...
        switch (getIntent().getStringExtra("title")){
            case "学校作业":
                url = NetConstantUrl.FIVE_PUBLIC_URL+"&a=homeworknotice&id=" + id;
                break;
            case "校本课程":
                url = NetConstantUrl.FIVE_PUBLIC_URL+"&a=schoolsyl&id=" + id;
                break;
            case "选修课程":
                url = NetConstantUrl.FIVE_PUBLIC_URL+"&a=schoolsylchoice&id=" + id;
                break;
            case "课时":
                url = NetConstantUrl.FIVE_PUBLIC_URL+"&a=classtime&id=" + id;
                break;
            case "期末检测":
                url = NetConstantUrl.FIVE_PUBLIC_URL+"&a=endtest&id=" + id;
                break;
            case "节假日":
                url = NetConstantUrl.FIVE_PUBLIC_URL+"&a=holiday&id=" + id;
                break;
        }
