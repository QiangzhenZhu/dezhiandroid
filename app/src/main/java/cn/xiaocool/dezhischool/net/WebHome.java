...
public interface WebHome  {
    ...
    //添加 在线请假
    String LEAVE_ADD = NET_API_HOST3 + "a=addleave";
    /**
     * 获取老师点评
     */
    String GET_TEACOMMENT = NET_API_HOST3 + "a=GetTeacherComment";
    /**
     * 获取通知公告栏
     */
  ...
  **/
    ...
    **/
     ...
     * 获取教师列表
     */
    String Meeting_Teacher = "http://dezhi.xiaocool.net/index.php?g=apps&m=school&a=getclassteacherlist";
    /**
     * 获取待接确认列表
     */
     ...
     * 发送点评信息
     */
    String ADD_TEACHERCOMMENT=NET_API_HOST1+"a=AddTeacherComment";
    /**
     * 发送通知公告
     */
